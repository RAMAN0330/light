...
export function Icon(props: any){
    ...
    switch(name){
        ...
        case 'security':
            ...
            break;
        case 'git-branch':
            children=[React.createElement('line',Object.assign({key:'l1',x1:'6',y1:'3',x2:'6',y2:'15'},common)),React.createElement('circle',Object.assign({key:'c1',cx:'18',cy:'6',r:'3'},common)),React.createElement('circle',Object.assign({key:'c2',cx:'6',cy:'18',r:'3'},common)),React.createElement('path',Object.assign({key:'p1',d:'M18 9a9 9 0 0 1-9 9'},common))];
            break;
        case 'git-merge':
            children=[React.createElement('circle',Object.assign({key:'c1',cx:'18',cy:'18',r:'3'},common)),React.createElement('circle',Object.assign({key:'c2',cx:'6',cy:'6',r:'3'},common)),React.createElement('path',Object.assign({key:'p1',d:'M6 21V9a9 9 0 0 0 9 9'},common))];
            break;
        case 'github':
            children=[React.createElement('path',Object.assign({key:'p1',d:'M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22'},common))];
            break;
        default:
            children=[React.createElement('path',Object.assign({key:'p1',d:'M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z'},common)),React.createElement('polyline',Object.assign({key:'p2',points:'14 3 14 8 19 8'},common))];
    }
